window.addEventListener('DOMContentLoaded',function(e){
  ...
  var containerDom = document.getElementById('container'),
      ...
      afterDom = document.getElementsByClassName('after')[0],
      pauseDom =document.getElementsByClassName('pause')[0],
      boxDom = document.getElementsByClassName('box')[0],
      sliderDom = document.getElementsByClassName('slider')[0],
      swiperDom =document.getElementsByClassName('swiper')[0],
      textDom =document.getElementsByClassName('text')[0],
      scrollDom =document.getElementsByClassName('content')[0],
      nameDom =document.getElementsByClassName('music-name')[0],
      singerDom =document.getElementsByClassName('singer')[0],
      listDom =document.getElementsByClassName('list')[0],
      musicListDom =document.getElementsByClassName('music-list')[0],
      scrollProDom = document.getElementsByClassName('scroll-pro')[0],
      lrcPlayDom =document.getElementsByClassName('lrc-play')[0],
      lrcTimeDom = document.getElementsByClassName('lrc-time')[0],
      mark = true;
